...
def run_inexact_index_experiment(data, index, lookup_pattern, lookup_beta_a=None, lookup_beta_b=None, insertion_lookup_interspersion='random_uniform', verbose=False, show_graph=False, graph_filename=None):
    """
...
def main():
    ...
    training_loss, evaluation_loss, _, _ = run_inexact_index_experiment(
